...
Versao: **1.0.109 - failover remoto com reserva residencial**
...
```powershell
docker build -f server/Dockerfile -t ryang20/prumo-api:1.0.109 .
# Opcional, somente quando a autenticacao do registry estiver valida:
docker push ryang20/prumo-api:1.0.109
```
