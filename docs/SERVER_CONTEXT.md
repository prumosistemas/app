...
```powershell
cd C:\Users\ryang\Desktop\projetosv2\projeto
docker build -f server/Dockerfile -t ryang20/prumo-api:1.0.105 .
docker push ryang20/prumo-api:1.0.105
```
...
cd /opt/prumo/app/deploy
# conferir .env sem imprimir segredos; PRUMO_API_IMAGE=ryang20/prumo-api:1.0.105
