...
- Na 1.0.57, um quadro temporal que mostra apenas o fundo é recapturado como `visual_challenge_not_ready`, sem ser contado como falha do Modo IA. O Modal continua limitado a 90 segundos para controlar custo; o ThinkPad usa até 240 segundos para preservar o progresso de desafios com muitas etapas.
- Na 1.0.58, o circuito de falhas do Modo IA registra o instante de abertura e se rearma em 300 segundos. Isso impede que um container Modal aquecido permaneça recusando solves indefinidamente.
